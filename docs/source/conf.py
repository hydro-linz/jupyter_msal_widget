...
# -*- coding: utf-8 -*-
#
# jupyter_msal_widget documentation build configuration file
#
...
project = 'jupyter_msal_widget'
copyright = '2022, Felipe Oucharski'
...
_version_py = os.path.join(repo, 'jupyter_msal_widget', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'jupyter_msal_widgetdoc'
...
latex_documents = [
    (master_doc, 'jupyter_msal_widget.tex', 'jupyter_msal_widget Documentation',
     'Felipe Oucharski', 'manual'),
]
...
man_pages = [
    (master_doc,
    'jupyter_msal_widget',
    'jupyter_msal_widget Documentation',
     [author], 1)
]
